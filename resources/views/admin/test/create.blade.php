            ...
            $('.add-question').on('click', function(){
                ...
                $('#questions').append('<div class="question">'
                    ...
                    + '<div class="card-body">'
                        + '<div class="d-flex flex-column">'
                            + '<div class="col-12 d-flex flex-row">'
                                + '<input type="text" class="form-control col-10 mr-2" placeholder="Option 1" name="question_answer_1_text">'
                                + '<select class="form-control" name="question_answer_1_point">'
                                    + '<option value = "0">0</option>'
                                    + '<option value = "1">1</option>'
                                + '</select>'
                            + '</div>'
                            + '<div class="col-12 d-flex flex-row">'
                                + '<input type="text" class="form-control col-10 mr-2" placeholder="Option 2" name="question_answer_2_text">'
                                + '<select class="form-control" name="question_answer_2_point">'
                                    + '<option value = "0">0</option>'
                                    + '<option value = "1">1</option>'
                                + '</select>'
                            + '</div>'
                            + '<div class="col-12 d-flex flex-row">'
                                + '<input type="text" class="form-control col-10 mr-2" placeholder="Option 3" name="question_answer_3_text">'
                                + '<select class="form-control" name="question_answer_3_point">'
                                    + '<option value = "0">0</option>'
                                    + '<option value = "1">1</option>'
                                + '</select>'
                            + '</div>'
                            + '<div class="col-12 d-flex flex-row">'
                                + '<input type="text" class="form-control col-10 mr-2" placeholder="Option 4" name="question_answer_4_text">'
                                + '<select class="form-control" name="question_answer_4_point">'
                                    + '<option value = "0">0</option>'
                                    + '<option value = "1">1</option>'
                                + '</select>'
