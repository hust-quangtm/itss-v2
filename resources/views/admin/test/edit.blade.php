            ...
            $('.add-question').on('click', function(){
                ...
                $('#questions').append('<div class="question">'
                    ...
                    + '<div class="card-body">'
                        + '<div class="d-flex flex-column">'
                            + '<div class="col-12 d-flex flex-row option">'
                                + '<input type="text" class="form-control col-10 mr-2" placeholder="Option 1" name="question_answer_text" required>'
                                + '<select class="form-control" name="question_answer_point">'
                                    + '<option value = "0">0</option>'
                                    + '<option value = "1">1</option>'
                                + '</select>'
                            + '</div>'
                            + '<div class="col-12 d-flex flex-row option">'
                                + '<input type="text" class="form-control col-10 mr-2" placeholder="Option 2" name="question_answer_text" required>'
                                + '<select class="form-control" name="question_answer_point">'
                                    + '<option value = "0">0</option>'
                                    + '<option value = "1">1</option>'
                                + '</select>'
                            + '</div>'
                            + '<div class="col-12 d-flex flex-row option">'
                                + '<input type="text" class="form-control col-10 mr-2" placeholder="Option 3" name="question_answer_text" required>'
                                + '<select class="form-control" name="question_answer_point">'
                                    + '<option value = "0">0</option>'
                                    + '<option value = "1">1</option>'
                                + '</select>'
                            + '</div>'
                            + '<div class="col-12 d-flex flex-row option">'
                                + '<input type="text" class="form-control col-10 mr-2" placeholder="Option 4" name="question_answer_text" required>'
                                + '<select class="form-control" name="question_answer_point">'
                                    + '<option value = "0">0</option>'
                                    + '<option value = "1">1</option>'
                                + '</select>'
