...
<footer class="container-fluid p-0 m-0">
    <div class="container-content">
        <div class="hapo-footer-content row d-flex">
            ...
            <a href="#" class="d-flex align-items-center justify-content-center" data-toggle="tooltip" data-placement="top" title="facebook.com/tuyen.dung.haposoft"><img class="img-facebook" src="{{url('storage/images/facebook-icon.png')}} "></a>
                    <a href="#" class="d-flex align-items-center justify-content-center" data-toggle="tooltip" data-placement="top" title="+84-85-645-9898"><img class="img-call" src="{{url('storage/images/call-icon.png')}}"></a>
                    <a href="#" class="d-flex align-items-center justify-content-center" data-toggle="tooltip" data-placement="top" title="info@haposoft.comm"><span><i class="fa fa-envelope icon-mail"></i></span></a>
                </div>
            </div>
        </div>
    </div>
